...
class SpectrumRendererGpu : public QOpenGLWidget, protected QOpenGLFunctions, public XSpectrumRenderer {
    Q_OBJECT
...
public:
    ...
    void setStyle(const QColor& color, int lineWidth, bool filled, int fillAlpha, SpectrumProfileType type, SpectrumProfileDirection direction) override;
...
private:
    ...
    SpectrumProfileDirection m_direction = SpectrumProfileDirection::Horizontal;
};
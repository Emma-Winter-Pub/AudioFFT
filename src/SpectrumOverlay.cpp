...
XSpectrumRenderer* SpectrumOverlay::currentRenderer() {
...
void SpectrumOverlay::setStyle(const QColor& color, int lineWidth, bool filled, int fillAlpha, SpectrumProfileType type, SpectrumProfileDirection direction) {
    m_currentStyle = {color, lineWidth, filled, fillAlpha, type, direction};
    currentRenderer()->setStyle(color, lineWidth, filled, fillAlpha, type, direction);
}

...
namespace FastConfig {
    ...
    constexpr int IMAGE_SAVE_TOP_MARGIN = 30;
    constexpr int IMAGE_SAVE_BOTTOM_MARGIN = 30;
    constexpr int IMAGE_SAVE_LEFT_MARGIN = 35;
    constexpr int IMAGE_SAVE_RIGHT_MARGIN = 55;
    constexpr int IMAGE_SAVE_COLOR_BAR_WIDTH = 15;
    constexpr int IMAGE_SAVE_DEFAULT_MAX_WIDTH = 2000;
    constexpr int IMAGE_SAVE_MIN_MAX_WIDTH = 500;
    constexpr int IMAGE_SAVE_MAX_MAX_WIDTH = 10000;
    constexpr int PNG_SAVE_DEFAULT_COMPRESSION_LEVEL = 1;
    constexpr int JPG_SAVE_DEFAULT_QUALITY = 85;
    constexpr int JPEG_MAX_DIMENSION = 65535;
    constexpr int IMAGE_WEBP_MAX_DIMENSION = 16383;
    constexpr int IMAGE_AVIF_MAX_DIMENSION = 8192;

...
class PlayerFfmpegProvider : public XPlayerProvider {
public:
...
private:
    AudioDecoderTypes::AVFormatContextPtr m_formatCtx;
    AudioDecoderTypes::AVCodecContextPtr m_codecCtx;
    AudioDecoderTypes::AVPacketPtr m_packet;
    AudioDecoderTypes::AVFramePtr m_frame;

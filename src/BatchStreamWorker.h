...
private:
    void checkPause();
    bool processSingleFile(BatchStreamTask& task, const BatchStreamSettings& settings, BatchStreamFFT& fft, BatchStreamGenerator& generator, QString& errorMsg, bool& outIsResized, qint64& elapsedMsOut);

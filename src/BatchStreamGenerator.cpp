...
void BatchStreamGenerator::init(int targetHeight, int fftSize, int sampleRate, CurveType curve, const QString& paletteId, bool paletteInverted, bool paletteNegative, double minDb, double maxDb) {
    ...
    m_colorTable = ColorPaletteFactory::instance().getPalette(paletteId, paletteInverted, paletteNegative);

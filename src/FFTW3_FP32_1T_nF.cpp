...
FFTW3_FP32_1T_nF::FFTW3_FP32_1T_nF() : m_impl(std::make_unique<Impl>()) {}

FFTW3_FP32_1T_nF::~FFTW3_FP32_1T_nF() = default;

bool FFTW3_FP32_1T_nF::initialize(const FFTParameters& params) {
    m_params = params;
...
std::optional<SpectrumDataVariant> FFTW3_FP32_1T_nF::compute(const PCMDataVariant& inputPcm) {
    ...
    while (currentFrameIdx < fullFrames) {
        ...
        for (int b = 0; b < framesToProcess; ++b) {
            ...
            for (int i = 0; i < binCount; ++i) {
                ...
                float power = (real * real + imag * imag) / normFactorSq;

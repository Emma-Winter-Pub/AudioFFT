...
namespace FastTypes {
    using FastPcmData32 = std::vector<float, AlignedAllocator<float, 64>>;
    using FastPcmData64 = std::vector<double, AlignedAllocator<double, 64>>;
    using FastPcmDataVariant = std::variant<FastPcmData32, FastPcmData64>;
    using FastSpectrumData32 = std::vector<float, AlignedAllocator<float, 64>>;
    using FastSpectrumData64 = std::vector<double, AlignedAllocator<double, 64>>;
    using FastSpectrumDataVariant = std::variant<FastSpectrumData32, FastSpectrumData64>;

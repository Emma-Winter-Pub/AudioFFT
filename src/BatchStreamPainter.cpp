...
QImage BatchStreamPainter::drawFinalImage(
    ...
    const int topMargin = settings.enableComponents ? AppConfig::IMAGE_SAVE_TOP_MARGIN : 0;
    const int bottomMargin = settings.enableComponents ? AppConfig::IMAGE_SAVE_BOTTOM_MARGIN : 0;
    const int leftMargin = settings.enableComponents ? AppConfig::IMAGE_SAVE_LEFT_MARGIN : 0;
    const int rightMargin = settings.enableComponents ? AppConfig::IMAGE_SAVE_RIGHT_MARGIN : 0;
    const int colorBarWidth = settings.enableComponents ? AppConfig::IMAGE_SAVE_COLOR_BAR_WIDTH : 0;

...
public:
    ...
    QCheckBox*   m_cbMultiInstance = nullptr;
    QCheckBox*   m_cbAutoPlayExternal = nullptr;
    QComboBox*   m_cmbDefaultWorkspace = nullptr;
    ...
    QCheckBox*   m_cbAutoExpandOnPlay = nullptr;

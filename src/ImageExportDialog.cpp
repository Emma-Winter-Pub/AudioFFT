...
void ImageExportDialog::setupUi(bool isJpegAvailable, bool isWebpAvailable, bool isAvifAvailable) {
    setStyleSheet(R"(
        QDialog { 
    ...
    connect(m_browseButton, &QPushButton::clicked, this, &ImageExportDialog::onBrowsePath);
    ...
    connect(m_buttonBox, &QDialogButtonBox::accepted, this, &ImageExportDialog::onAccept);
    connect(m_buttonBox, &QDialogButtonBox::rejected, this, &QDialog::reject);
    connect(m_formatComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &ImageExportDialog::onFormatChanged);
...
void ImageExportDialog::onAccept() {
...
QString ImageExportDialog::getSelectedFormatIdentifier() const {
    return m_formatComboBox->currentData().toString();
}

QString ImageExportDialog::getSelectedFilePath() const {
...
int ImageExportDialog::qualityLevel() const { return m_qualitySlider->value(); }

void ImageExportDialog::onBrowsePath() {
...
void ImageExportDialog::onFormatChanged(int index) {
    if (index < 0) return;

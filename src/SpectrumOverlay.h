...
public:
    ...
    void clearData();
    void setStyle(const QColor& color, int lineWidth, bool filled, int fillAlpha, SpectrumProfileType type, SpectrumProfileDirection direction);
...
private:
    ...
    XSpectrumRenderer* m_cpuRenderer;
    XSpectrumRenderer* m_gpuRenderer;
    ...
    struct Style {
        ...
        SpectrumProfileDirection direction = SpectrumProfileDirection::Horizontal;
    } m_currentStyle;
    QRect m_currentRect;
    bool m_gpuEnabled = false;
    XSpectrumRenderer* currentRenderer();

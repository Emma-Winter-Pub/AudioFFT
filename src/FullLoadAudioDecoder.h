...
class FullLoadAudioDecoder : public QObject {
    Q_OBJECT
public:
    explicit FullLoadAudioDecoder(QObject* parent = nullptr);
    ...
    const AudioDecoderTypes::AudioMetadata& getMetadata() const { return m_metadata; }

signals:
    void logMessage(const QString& msg);

private:
    bool singleThreadedDecode(const QString& filePath, int trackIndex, int targetChannelIdx, double startSec, double endSec);   
    ...
    AudioDecoderTypes::AudioMetadata m_metadata;
